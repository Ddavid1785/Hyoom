  ...
  return (
    ...
    >
      <AnimatePresence mode="popLayout">
        {recentMessages.map((message, index) => {
          ...
          return (
            ...
            >
              {!isUser && (
                <div className="flex-shrink-0 w-7 h-7 rounded-full bg-blue-600/20 flex items-center justify-center">
              ...
              {isUser && (
                <div className="flex-shrink-0 w-7 h-7 rounded-full bg-zinc-700/40 flex items-center justify-center">
      ...
      <motion.div
        ...
        className="h-px bg-gradient-to-r from-transparent via-zinc-700/50 to-transparent mt-4"
      />
    </motion.div>
  );
}